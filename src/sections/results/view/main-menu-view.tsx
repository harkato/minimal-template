...
function ResultsPage() {
  return <div><Typography variant="h4">Página de Resultados</Typography></div>;
}

function OtherPage({ title }: { title: string }) {
  return <div><Typography variant="h4">{title}</Typography></div>;
}
    ...
    <DashboardContent>
        <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={12}>
                <Typography variant="h4" mb="10px">General</Typography>
                <Grid container spacing={1}>
                    <Button variant="contained" color="primary" sx={{ margin: '1%', width: '100%', maxWidth: 150, padding: 1 }} onClick={() => handleNavigation('/results')}>
                        <Stack direction="column" alignItems="center" spacing={0.5}>
                            <Iconify icon="ic:round-view-list" width='3em'/>
                            <Typography variant="button">Result</Typography>
                        </Stack>
                    </Button>
                    <Button variant="contained" color="primary" sx={{ margin: '1%', width: '100%', maxWidth: 150, padding: 1 }} onClick={() => handleNavigation('/user')}>
                        <Stack direction="column" alignItems="center" spacing={0.5}>
                            <Iconify icon="mdi:users" width="3em" />
                            <Typography variant="button">Users</Typography>
                        </Stack>
                    </Button>     
                    <Button variant="contained" color="primary" sx={{ margin: '1%', width: '100%', maxWidth: 150, padding: 1 }} onClick={() => handleNavigation('/event')}>
                        <Stack direction="column" alignItems="center" spacing={0.5}>
                            <Iconify icon="material-symbols:info" width='3em' />
                            <Typography variant="button">Event</Typography>
                        </Stack>
                    </Button>
                    <Button variant="contained" color="primary" sx={{ margin: '1%', width: '100%', maxWidth: 150, padding: 1 }} onClick={() => handleNavigation('/program-detail')}>
                        <Stack direction="column" alignItems="center" spacing={0.5}>
            ...
            <Grid item xs={12} md= {12}>
                <Typography variant="h4" mb="10px">Tightening</Typography>
                <Grid container spacing={1}>
                    <Button variant="contained" color="primary" sx={{ margin: '1%', width: '100%', maxWidth: 150, padding: 1 }} onClick={() => handleNavigation('/job-result')}>
                        <Stack direction="column" alignItems="center" spacing={0.5}>
                            <Iconify icon="ic:round-view-list" width='3em'/>
            ...
            {/* Categoria: Adhesive */}
            <Grid item xs={12} md={12}>
                <Typography variant="h4" mb="10px">Adhesive</Typography>
                <Grid container spacing={1}>
                    <Button variant="contained" color="primary" sx={{ margin: '1%', width: '100%', maxWidth: 150, padding: 1 }} onClick={() => handleNavigation('/adhesive-result')}>
                        <Stack direction="column" alignItems="center" spacing={0.5}>
                            <Iconify icon="ic:round-view-list" width='3em'/>
